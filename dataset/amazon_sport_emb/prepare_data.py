...
if __name__ == '__main__':
    ...
    parser.add_argument('--core', type=int, default=9, help="K-core filtering threshold.")
    parser.add_argument('--review_path', type=str, default='dataset/amazon_sport_emb/raw_data/amazon_sports_and_outdoors_9_core_sentiment_20251226.jsonl', help="Path to the review data file with sentiment.")
    parser.add_argument('--meta_path', type=str, default='dataset/amazon_sport_emb/raw_data/amazon_sports_and_outdoors_metadata_w_embd_20251226.jsonl', help="Path to the metadata file with embeddings.")
    parser.add_argument('--output_dir', type=str, default='dataset/amazon_sport_emb/', help="Base directory for output.")
