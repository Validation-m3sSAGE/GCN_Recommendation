...
if __name__ == '__main__':
    ...
    parser.add_argument('--review_path', type=str, default='dataset/amazon_books_senti/raw_data/amazon_books_20_core_sentiment_20251206.jsonl', help="Path to the review data file.")
    parser.add_argument('--meta_path', type=str, default='dataset/amazon_books_senti/raw_data/amazon_books_20_core_sentiment_20251206_meta.jsonl', help="Path to the metadata file.")
    parser.add_argument('--output_dir', type=str, default='dataset/amazon_books_senti/processed_data_20', help="Base directory for output.")
